...
import { MdOutlineDesignServices, MdOutlineBarChart } from 'react-icons/md';
import { FaProjectDiagram } from 'react-icons/fa';
import PowerBIIcon from './icons/PowerBIIcon'; // custom SVG component
...
const skills = [
    ...
    {
        Icon: PowerBIIcon, // ✅ dùng SVG custom
        className: '',
        label: 'Power BI',
        category: 'Tools'
    },
    {
        Icon: FaProjectDiagram, // ✅ thay cho Visual Paradigm
        className: 'text-blue-400',
        label: 'Visual Paradigm',
        category: 'Tools'
    },
    {
        Icon: MdOutlineDesignServices, // ✅ thay cho EdrawMax

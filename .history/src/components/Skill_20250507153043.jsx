...
const skills = [
    ...
    {
        // Postman icon with transparent background
        Icon: () => (
            <img
                src='https://w7.pngwing.com/pngs/17/131/png-transparent-postman-logo-thumbnail-tech-companies.png' // Transparent PNG link
                alt='Postman'

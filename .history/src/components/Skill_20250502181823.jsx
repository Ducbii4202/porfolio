...
const skills = [
    { Icon: BiLogoJavascript, className: 'text-yellow-400', label: 'JavaScript', category: 'Frontend' },
    { Icon: BiLogoTypescript, className: 'text-blue-400', label: 'TypeScript', category: 'Frontend' },
    { Icon: RiReactjsFill, className: 'text-cyan-400', label: 'React', category: 'Frontend' },
    { Icon: RiTailwindCssLine, className: 'text-cyan-400', label: 'Tailwind CSS', category: 'Frontend' },
    { Icon: DiSass, className: 'text-pink-400', label: 'Sass', level: 70, category: 'Frontend' },
    { Icon: SiFigma, className: 'text-pink-500', label: 'Figma', level: 75, category: 'Frontend' },
    { Icon: SiNodedotjs, className: 'text-green-500', label: 'Node.js', category: 'Backend' },
    { Icon: SiMongodb, className: 'text-green-500', label: 'MongoDB', category: 'Database' },
    { Icon: BiLogoPostgresql, className: 'text-sky-700', label: 'PostgreSQL', category: 'Database' }
];
    ...
    return (
        <section className='pt-16 pb-8 px-3' id='skills'>
            ...
            <AnimatePresence mode='wait'>
                ...
                >
                    {filteredSkills.map(({ Icon, className, label, level = 80 }, index) => {
                        const offset =

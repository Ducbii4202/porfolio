            ...
            <div className='flex flex-col lg:flex-row flex-wrap'>
                ...
                <div className='w-full lg:w-1/2 p-4 flex flex-col justify-center lg:justify-start'>
                    ...
                    <motion.p
                        ...
                        className='max-w-xl py-6 px-2 rounded-lg text-justify leading-relaxed transition-all duration-300 hover:text-blue-500 hover:bg-neutral-100 dark:hover:text-blue-400 '
                    >

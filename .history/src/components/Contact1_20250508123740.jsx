...
const Contact1 = () => {
    ...
    return (
        <section
            className='pt-12 pb-20 flex flex-col justify-center items-center px-4 md:px-10'
            id='contact'
        >
            <motion.h1
            ...
            <form
                ref={form}
                onSubmit={sendEmail}
                className='mx-auto bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-lg space-y-4 w-[500px] h-[600px] flex flex-col justify-between'
            >
                <div>
                ...
                <div className='flex-1'>
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        rows='5'
                        className='w-full h-full px-4 py-2 border border-neutral-300 dark:border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white resize-none'
                        required
                    ></textarea>
                </div>

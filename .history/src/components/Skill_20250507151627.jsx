...
import { FaPostman, FaDatabase } from 'react-icons/fa'; // Import the icons
...
const skills = [
    ...
    {
        Icon: FaPostman, // Now the Postman icon is properly imported
        className: 'text-orange-500',
        label: 'Postman',
        category: 'Tools'
    },
    {
        Icon: FaDatabase, // Now the DBeaver icon is properly imported

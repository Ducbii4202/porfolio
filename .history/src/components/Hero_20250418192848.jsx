...
const Hero = () => {
    return (
        <section className='w-full overflow-x-hidden bg-black'>
            <div className='max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between min-h-screen text-white px-4 md:px-8'>
                {/* TEXT */}
                <motion.div
                ...
                {/* IMAGE */}
                <motion.div
                    className='w-full md:w-1/2 flex justify-center py-8'
                    initial='hidden'
                    whileInView='visible'
                    viewport={{ once: true, amount: 0.3 }}

            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4'>
                {PROJECTS.map((project, index) => (
                    <motion.div
                        ...
                        title={project.stack} // ✅ Tooltip hiển thị Stack
                    >
                        {/* Background Image */}
                        <img
                            src={project.image}
                        ...
                        <div className='relative z-10 h-full flex flex-col justify-between p-6'>
                            <div className='bg-gray-800/80 text-white rounded-lg p-4 shadow-lg backdrop-blur-sm'>
                           ...
                           transition-all duration-300 w-fit mt-6 items-center'
                            >
                                View on GitHub
                            </a>
                        </div>
